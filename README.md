...
![Build Status](https://github.com/StefanoPernat/devops-capstone-project/actions/workflows/ci-build.yml/badge.svg)

This repository contains the my devops-capstone-project the template is here [**IBM-CD0285EN-SkillsNetwork DevOps Capstone Project**](https://www.coursera.org/learn/devops-capstone-project?specialization=devops-and-software-engineering) which is part of the [**IBM DevOps and Software Engineering Professional Certificate**](https://www.coursera.org/professional-certificates/devops-and-software-engineering)
...
some edit for the pull request